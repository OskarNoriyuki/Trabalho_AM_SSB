...
class ssb_oskar_21mai(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "ssb_oskar_21mai")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ssb_oskar_21mai")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ssb_oskar_21mai")
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, carrier_freq, .5, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, carrier_freq, .5, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, carrier_freq, 1, 0, 0)
        self.analog_agc2_xx_0 = analog.agc2_cc(agc_attack, agc_decay, .5, 1)
        ...
        self.connect((self.band_pass_filter_0, 0), (self.channels_channel_model_0, 0))
        ...
        self.connect((self.blocks_float_to_complex_0, 0), (self.qtgui_waterfall_sink_x_2, 0))
        self.connect((self.blocks_float_to_complex_1, 0), (self.qtgui_waterfall_sink_x_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 20000, 6000, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=ssb_oskar_21mai, options=None):
